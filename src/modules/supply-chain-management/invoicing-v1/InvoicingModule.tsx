    ...
    return (
        <div className="space-y-8 p-6 max-w-[1600px] mx-auto min-h-screen bg-transparent">
            <div className="flex flex-col gap-6">
                <div className="flex items-center gap-2 text-sm text-muted-foreground/60 font-medium font-mono tracking-tighter uppercase">
                    <span>Supply Chain</span>
                    <ChevronRight size={12} className="opacity-50" />
                    <span className="text-primary font-bold">Invoicing</span>
                </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                    <div className="space-y-3">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-4xl md:text-6xl font-black tracking-tight text-foreground/90 uppercase italic">
                                    Invoicing
                                </h1>
                        ...
                        <p className="text-muted-foreground text-base max-w-xl leading-relaxed">
                            Efficiently manage and process sales orders. Orders are <span className="text-primary font-bold decoration-primary/30 decoration-2 underline-offset-4 underline">automatically categorized by customer</span> to streamline your workflow.
                        </p>
                    </div>
