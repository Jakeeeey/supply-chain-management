...
export function useStockAdjustmentForm() {
  ...
  const fetchBranches = useCallback(async () => {
    try {
      const response = await fetch("/api/scm/inventory-management/stock-adjustment-registration/branches");
  ...
  const fetchProducts = useCallback(async (search?: string) => {
    ...
    try {
      const response = await fetch(
        `/api/scm/inventory-management/stock-adjustment-registration/products${search ? `?search=${search}` : ""}`
      );
      const result = await response.json();
  ...
  const fetchSuppliers = useCallback(async () => {
    ...
    try {
      const response = await fetch("/api/scm/inventory-management/stock-adjustment-registration/suppliers");
      const result = await response.json();
  ...
  const fetchProductsBySupplier = useCallback(async (supplierId: number, search?: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/scm/inventory-management/stock-adjustment-registration/products?${params.toString()}`
      );
      const result = await response.json();
      setProducts(result.data || []);
    } catch (err) {
  ...
  const fetchBranchRfidData = useCallback(async (branchId: number) => {
    ...
    try {
      const response = await fetch(
        `/api/scm/inventory-management/stock-adjustment-registration/rfid-products?branchId=${branchId}`
      );
  ...
  const fetchBranchInventory = useCallback(async (branchId: number) => {
    ...
    try {
      const response = await fetch(
        `/api/scm/inventory-management/stock-adjustment-registration/branch-inventory?branchId=${branchId}`
      );
      if (!response.ok) return;
      const result = await response.json();
  ...
  const fetchById = useCallback(async (id: number): Promise<StockAdjustmentDetail> => {
    const response = await fetch(`/api/scm/inventory-management/stock-adjustment-registration/${id}`);
    const result = await response.json();
  ...
  const fetchInventory = useCallback(async (productId: number, branchId: number): Promise<number> => {
    try {
      const response = await fetch(
        `/api/scm/inventory-management/stock-adjustment-registration/inventory?productId=${productId}&branchId=${branchId}`
      );
  ...
  const checkRFID = useCallback(async (productId: number, branchId: number): Promise<Record<string, unknown> | null> => {
    try {
      const response = await fetch(
        `/api/scm/inventory-management/stock-adjustment-registration/check-rfid?productId=${productId}&branchId=${branchId}`
      );
  ...
  const createAdjustment = useCallback(async (values: StockAdjustmentFormValues) => {
    const response = await fetch("/api/scm/inventory-management/stock-adjustment-registration", {
      method: "POST",
  ...
  const postAdjustment = useCallback(async (id: number) => {
    const response = await fetch(`/api/scm/inventory-management/stock-adjustment-registration/${id}/post`, {
      method: "POST",
    });
    const result = await response.json();
    if (result.error) throw new Error(result.error);
