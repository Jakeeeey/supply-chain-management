  ...
  return (
    <div className="flex flex-col gap-4 p-4 h-full overflow-hidden bg-background">
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-bold tracking-tight text-foreground">Stock Adjustments</h1>
        <p className="text-sm text-muted-foreground">Manage and track stock adjustment requests</p>
      </div>
