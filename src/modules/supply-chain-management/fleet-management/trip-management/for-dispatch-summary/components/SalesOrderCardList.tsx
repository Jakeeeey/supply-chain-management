...
import type { ForDispatchSalesOrder } from "../types/for-dispatch-summary.types";
import { Card, CardContent } from "@/components/ui/card";
import { MapPin, Banknote, Truck, Box } from "lucide-react";
import { buildAddress, formatCurrency } from "../services/for-dispatch-summary.helpers";
            ...
            <CardContent className="p-8 relative">
              <div className="flex flex-col h-full justify-between gap-6">
                ...
                <div className="grid grid-cols-1 gap-4 pt-4 border-t border-border/40">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-xl flex items-center justify-center border bg-muted/30 border-border/40 group-hover:border-emerald-500/30 group-hover:bg-emerald-500/5 transition-all">
                      <Banknote className="h-5 w-5 text-muted-foreground group-hover:text-emerald-600" />
                    </div>
                    <div className="flex flex-col min-w-0 leading-tight">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-xl flex items-center justify-center border bg-muted/30 border-border/40 group-hover:border-emerald-500/30 group-hover:bg-emerald-500/5 transition-all">
                        <Truck className="h-5 w-5 text-muted-foreground group-hover:text-emerald-600" />
                      </div>
