/**
 * Low-level HTTP client for the Bundling module.
 * Mirrors the pattern from sku-api.ts for consistency.
 */
...
export async function request<T>(
  ...
  if (!response.ok) {
    ...
    console.error(
      `[Bundle API Error] [${response.status}] ${url}:`,
 ...
 * @param endpoint - Directus collection endpoint (e.g. /items/product_bundles)
