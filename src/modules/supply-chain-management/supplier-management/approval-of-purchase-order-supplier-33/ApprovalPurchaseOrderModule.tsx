...
export default function ApprovalPurchaseOrderModule({ approverId, approverName }: { approverId?: number; approverName?: string; }) {
    ...
    const refreshList = React.useCallback(async () => {
        try {
            ...
            // Filter to only include POs from supplier 33
            const filteredData = data.filter(po => String(po.supplierId) === "33" || String(po.supplier_name) === "33");
    ...
    const onApprove = React.useCallback(
        async (opts: {
            ...
            const promise = provider.approvePurchaseOrder({
                id: selectedId,
                ...opts,
    ...
    return (
        <div className="w-full min-w-0 space-y-4">
            <div className="space-y-1">
                <div className="text-2xl font-black">Approval of Purchase Orders (Production)</div>
