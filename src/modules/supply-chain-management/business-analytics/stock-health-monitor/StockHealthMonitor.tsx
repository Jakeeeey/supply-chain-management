            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">
                  {stockHealth.summary.atRiskCount}
                </h3>
                <p className="text-xs opacity-70 mt-1">
                  Items below 15 days of stock
                </p>
              </div>
          ...
          <DataTable
            columns={[
              ...
              { accessorKey: "currentBalance", header: "Balance" },
              {
                accessorKey: "ads30",
                header: "ADS (30d)",
                cell: ({ row }) => row.original.ads30.toFixed(2),
              },
              {
                ...
                cell: ({ row }) => {
                  ...
                  return (
                    <div className="flex items-center gap-2">
                      <span
                        className={cn(
                          days <= 15 ? "text-rose-600 font-bold" : "",
                        )}
                      >
                        {days.toFixed(1)}
                      </span>
              ...
              },
              {
                ...
                cell: ({ row }) => {
                  ...
                  if (row.original.isStockOutRisk)
                    return (
                      <Badge
                        variant="outline"
                  ...
                  return (
                    <Badge
                      variant="outline"
                      className="text-emerald-500 border-emerald-200"
                    >
                      Healthy
                    </Badge>
                  );
              ...
              },
              {
                ...
                cell: ({ row }) => row.original.lastOutboundDate || "Never",
              },
            ]}
