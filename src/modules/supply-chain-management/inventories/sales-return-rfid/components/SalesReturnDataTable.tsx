...
export function SalesReturnDataTable<TData, TValue>({
  columns,
  data,
  pageCount,
  pagination,
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between px-2">
        <div className="flex-1 text-sm text-muted-foreground font-medium">
          Showing {table.getFilteredRowModel().rows.length} of {totalRecords ?? table.getFilteredRowModel().rows.length} records
