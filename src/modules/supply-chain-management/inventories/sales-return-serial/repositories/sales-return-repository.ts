// src/modules/supply-chain-management/inventories/sales-return-serial/repositories/sales-return-repository.ts
...
// =============================================================================
// REPOSITORY METHODS — SERIAL
// =============================================================================

/**
 * Creates a serial record in sales_return_serial.
 */
...
/**
 * Fetches serials for a specific sales return detail.
 */
...
/**
 * Fetches serials for multiple sales return details.
 */
