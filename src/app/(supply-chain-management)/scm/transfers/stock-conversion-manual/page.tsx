import StockConversionManualModule from "@/modules/supply-chain-management/transfers/stock-conversion-manual/StockConversionManualModule";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
        ...
        <div className="flex h-full items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Manual Stock Conversion</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
