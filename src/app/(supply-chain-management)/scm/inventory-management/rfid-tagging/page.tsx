...
import RfidTaggingPage from "@/modules/supply-chain-management/inventory-management/rfid-tagging/page";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "RFID Tagging | Supply Chain Management",
  description: "Register new RFID tags to products",
};
