...
import StockAdjustmentManualSummaryModule from "@/modules/supply-chain-management/inventory-management/stock-adjustment-manual-summary/StockAdjustmentManualSummaryModule";
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
                <StockAdjustmentManualSummaryModule />
            </main>
        </div>
    );
}
