import ProductRegistrationPage from "@/modules/supply-chain-management/product-management/product-registration/ProductRegistrationPage";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
        ...
        <div className="flex h-full items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Product Registration</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
