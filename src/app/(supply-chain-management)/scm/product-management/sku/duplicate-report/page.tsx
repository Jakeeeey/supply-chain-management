...
import { DuplicateReportModule } from "@/modules/supply-chain-management/product-management/sku/duplicate-report/DuplicateReportModule";
import {
    Breadcrumb,
    BreadcrumbItem,
    BreadcrumbLink,
                ...
                <div className="flex items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>Duplicate SKU Report</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
