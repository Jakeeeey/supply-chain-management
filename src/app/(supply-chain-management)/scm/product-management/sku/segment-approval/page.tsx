...
import SegmentApprovalPage from "@/modules/supply-chain-management/product-management/sku/segment-approval/SegmentApprovalPage";
...
export const metadata: Metadata = {
  title: "Segment Approval | VOS Web",
  description: "Review and approve product segment classifications.",
};
        ...
        <div className="flex h-full items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Segment Approval Queue</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
