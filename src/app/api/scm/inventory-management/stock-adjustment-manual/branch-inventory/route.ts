...
/**
 * GET /api/scm/inventory-management/stock-adjustment-manual/branch-inventory?branchId=190
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    const inventory = await stockAdjustmentManualService.fetchBranchInventory(Number(branchId), token);
