...
export async function POST(req: NextRequest) {
  try {
    ...
    // Resolve target folder name from formData (default to stock_adjustment_attachments)
    const targetFolderName = (formData.get("folder_name") as string) || "stock_adjustment_attachments";
