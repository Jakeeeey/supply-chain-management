...
export async function GET(
    ...
    try {
        ...
        const soHeaderRes = await fetch(`${DIRECTUS_BASE}/items/sales_order/${orderId}?fields=*,receipt_type.max_length,receipt_type.isOfficial,payment_terms.payment_name`, {
